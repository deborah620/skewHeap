...
private:
  ...
  Node* insertHelper(Node* p1, Node* p2);

  void clearHelper(Node *node);

  //void
  Node* copyHelper(Node* node, Node *copy);

  Node *assignmentHelper(Node *node, Node *copy);

  void printHelper(Node *nodeToPrint) const;

  //void printHelper(Node *nodeToPrint, int &i) const;

  void array(Node *&node, Node **dtreeArray, int &i);
